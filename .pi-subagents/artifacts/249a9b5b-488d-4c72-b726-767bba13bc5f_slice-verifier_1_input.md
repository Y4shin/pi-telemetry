# Task for slice-verifier

Verify slice "session-run-turn-capture" of task pi-telemetry.
...
Run npm run check and npm test (the fast suite). Block on failure.

---
**Output:**
Write your findings to exactly this path: /home/pplattner/Projects/pi-telemetry/.pi-subagents/artifacts/outputs/249a9b5b-488d-4c72-b726-767bba13bc5f/verify-session-run-turn-capture/result.md
